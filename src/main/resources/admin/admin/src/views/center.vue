  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiaolian'"  label="教练账号" prop="jiaolianzhanghao">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='jiaolian'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
