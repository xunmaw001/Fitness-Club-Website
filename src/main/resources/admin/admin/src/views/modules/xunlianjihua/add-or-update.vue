	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="训练内容" prop="xunlianneirong">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xunlianneirong" label="训练内容" prop="xunlianneirong">
                    <span :style='{"border":"1px solid #5497f2","padding":"0 40px","color":"#bbbbbb","borderRadius":"20px 40px","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.xunlianneirong"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.xunlianneirong = this.ruleForm.xunlianneirong.replace(reg,'../../../springbootrix1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
