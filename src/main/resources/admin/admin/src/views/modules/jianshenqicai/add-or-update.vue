	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="器材位置" prop="qicaiweizhi">
					<el-input v-model="ruleForm.qicaiweizhi" placeholder="器材位置" clearable  :readonly="ro.qicaiweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="器材位置" prop="qicaiweizhi">
					<el-input v-model="ruleForm.qicaiweizhi" placeholder="器材位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.qicaitupian" label="器材图片" prop="qicaitupian">
					<file-upload
						tip="点击上传器材图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.qicaitupian" label="器材图片" prop="qicaitupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qicaitupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.qicaijieshao" label="器材介绍" prop="qicaijieshao">
                    <span :style='{"border":"1px solid #5497f2","padding":"0 40px","color":"#bbbbbb","borderRadius":"20px 40px","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.qicaijieshao"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.qicaijieshao = this.ruleForm.qicaijieshao.replace(reg,'../../../springbootrix1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.qicaitupian!=null) {
		this.ruleForm.qicaitupian = this.ruleForm.qicaitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
